...
namespace SeleniumTests
{
    ...
    public class Login
    {
        ...
        public void TheLoginTest()
        {
            ...
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("Email")));
            driver.FindElement(By.Id("Email")).SendKeys("markan@lol.com");
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("Password")));
            driver.FindElement(By.Id("Password")).Clear();
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("Password")));
            driver.FindElement(By.Id("Password")).SendKeys("123456");
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("RememberMe")));
            driver.FindElement(By.Id("RememberMe")).Click();
            wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector("input.button-1.login-button")));
            driver.FindElement(By.CssSelector("input.button-1.login-button")).Click();
            wait.Until(ExpectedConditions.ElementIsVisible(By.LinkText("markan@lol.com")));
            driver.FindElement(By.LinkText("markan@lol.com")).Click();
